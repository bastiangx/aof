...
class FactoryHandler:
    ...
    def score_check(score: int) -> str:
        if 50 <= score <= 60 or 100 <= score <= 110 or 150 <= score <= 160:
            return str('wave')
        return str('regular')
...
class ZombieFactory:
    ...
    @staticmethod
    def spawner() -> Enemy:
        y = ru(CANVAS_HEIGHT + 900, CANVAS_HEIGHT + 3200)
        x = ru(65, CANVAS_WIDTH - 65)
...
class WaveFactory:
    ...
    def spawner() -> Enemy:
        ...
        y = ru(CANVAS_HEIGHT + 800, CANVAS_HEIGHT + 3100)
        x = ru(65, CANVAS_WIDTH - 65)
