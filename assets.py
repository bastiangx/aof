...
class Pathfinder:
    ...
    !! CASE SENSITIVE
    --------
        all paths + filenames are case sensitive regardless of OS
...
# shuriken
GAME_BULLET = Pathfinder.load_image('shuriken.png')
...
GAME_BG = Pathfinder.load_bg('map.png')
...
SE_GUNSHOT = Pathfinder.load_sound('fireball.wav')
